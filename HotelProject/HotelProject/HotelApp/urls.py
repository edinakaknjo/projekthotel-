...
urlpatterns = [
    ...
    path('hotel/registration', views.registration, name='registration'),
    path('index/registration', views.registration, name='registration'),
    path('search/registration', views.registration, name='registration'),
